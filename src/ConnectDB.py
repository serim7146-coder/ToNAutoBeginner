...
# 追加できない時はNoneを返す
def send_Users(VRChat_uid: str) -> int:
...
def send_ToNRoundStatistics(round_name: str, terror_ids: list[int], map_id: int, VRChat_uid: str):
    def _send_ToNRoundStatistics():
        try:
            ...
            data = json.dumps({
                ...
                "map_id": map_id,
                "transformed_uid": get_transformed_uid(VRChat_uid)
            }).encode()
            req = urllib.request.Request(
